...
class Unet(nn.Module):
    ...
    def __init__(self,
        ...
        self.proj_head = Proj_Head_Last(enc_nf[-1], out_dim)
    ...
    def forward(self, source, target):
        ...
        return x, src_vec, trg_vec, src_dense, trg_dense
...
class VxmDense(LoadableModel):
    ...
    def forward(self, X_aug, X, Y_aug, Y, registration=False):
        '''
        Parameters:
        ...
        x, src_vec, trg_vec, src_dense, trg_dense = self.unet_model(X_aug, Y_aug)
        ...
        y_source_aug = self.transformer(X_aug, pos_flow)

        # return non-integrated flow field if training
        return y_source, pos_flow, src_vec, trg_vec, src_dense, trg_dense
...
class Proj_Head_Last(nn.Module):
    def __init__(self, in_dim, out_dim):
        super(Proj_Head_Last, self).__init__()
